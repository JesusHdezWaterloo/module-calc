 ...
 */
public class CalcModuleNavigator implements NavigationService {

    public static final DerivableIcon CALC = new IconSVG(CalcModuleNavigator.class.getResourceAsStream("/calc.svg"));
